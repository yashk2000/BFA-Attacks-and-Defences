...
class BFA(object):
    ...
    def progressive_bit_search_litbfa(self, model, data, target, attack_layers):
        ''' 
        Given the model, base on the current given data and target, go through
        all the layer and identify the bits to be flipped. 
        '''
    ...
    def progressive_bit_search_lfreeze(self, model, data, target, frozen_layers):
        ''' 
        Given the model, base on the current given data and target, go through
        all the layer and identify the bits to be flipped. 
        '''
