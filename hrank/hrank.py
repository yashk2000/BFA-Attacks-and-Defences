...
from models import quan_alexnet_imagenet
...
parser.add_argument(
    '--data_dir',
    type=str,
    default='/../../home/candle/datasets/ILSVRC2012/',
    help='dataset path')
parser.add_argument(
    '--dataset',
    type=str,
...
parser.add_argument(
    ...
    type=str,
    default='vgg_16_bn',
    choices=('resnet_50','vgg_16_bn','resnet_56','resnet_110','densenet_40','googlenet','mobilenet_v2','mobilenet_v1','quan_alexnet_imagenet'),
