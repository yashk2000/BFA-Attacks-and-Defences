...
class Fire(nn.Module):
    ...
    def __init__(
        ...
        self.squeeze = quan_Conv2d(inplanes, squeeze_planes, kernel_size=1)
        self.squeeze_activation = nn.ReLU(inplace=True)
        self.expand1x1 = quan_Conv2d(squeeze_planes, expand1x1_planes,
                                   kernel_size=1)
        self.expand1x1_activation = nn.ReLU(inplace=True)
        self.expand3x3 = quan_Conv2d(squeeze_planes, expand3x3_planes,
    ...
    def __init__(
        ...
        if version == '1_0':
            self.features = nn.Sequential(
                quan_Conv2d(3, 96, kernel_size=7, stride=2),
            ...
            self.features = nn.Sequential(
                quan_Conv2d(3, 64, kernel_size=3, stride=2),
                nn.ReLU(inplace=True),
                nn.AvgPool2d(kernel_size=3, stride=2, ceil_mode=True),
                Fire(64, 16, 64, 64),
                Fire(128, 16, 64, 64),
        ...
        final_conv = quan_Conv2d(512, self.num_classes, kernel_size=1)
